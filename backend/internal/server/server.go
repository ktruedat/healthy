...
func New(cfg *config.Config, db *database.DB, logger log.Logger) *Server {
	...
	logger.Info("Server configuration details", "port", cfg.Server.Port, "timeout", cfg.Server.Timeout)
